...
const Hero = () => {
  ...
  return (
    <div className="relative h-full overflow-hidden">
      ...
      <div className={`relative z-10 flex flex-col items-center justify-center h-screen py-30 text-white px-4 transition-all duration-500 ${
        fade ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
      }`}>
        <div className="max-w-4xl flex flex-col gap-8 text-center mt-28">
          ...
          <div className="flex gap-6 justify-center">
            <button className="px-12 py-3 bg-transparent border-2 border-white text-white font-semibold rounded-lg hover:bg-yellow-500 hover:border-yellow-500 hover:text-black transition-all duration-300">
              Our Services
            </button>
            <button className="px-12 py-3 bg-transparent border-2 border-white text-white font-semibold rounded-lg hover:bg-yellow-500 hover:border-yellow-500 hover:text-black transition-all duration-300">
              Why Carca
